  ...
  return (
      ...
      <aside className="w-1/4 bg-neutral-800 p-4 flex flex-col border-l border-neutral-700">
        ...
        <div className="flex-1 overflow-y-auto space-y-2">
          {["Alex", "Ace", "Ares", "Aerson", "GaussTricky", "Orgil"].map((user, index) => (
            <div key={index} className="flex items-center space-x-2 p-2 bg-neutral-700 rounded cursor-pointer hover:bg-neutral-600">
              ...
              {/* Settings Button */}
        <button className="mt-4 p-2 bg-neutral-700 rounded hover:bg-neutral-600">Settings</button>
      </aside>
      ...
      <main className="flex-1 flex flex-col bg-neutral-800">
        ...
        <header className="bg-neutral-800 text-white p-3 flex items-center justify-between border-b border-neutral-700">
          <div className="flex items-center space-x-3">
            ...
            <input type="text" placeholder="Search" className="bg-neutral-700 text-white px-3 py-1 rounded focus:outline-none" />
          </div>
          <div className="flex items-center space-x-2">
            <img src="https://via.placeholder.com/32" className="w-8 h-8 rounded-full" alt="Group Icon" />
